...
export default function Header() {
  ...
  return (
    <div className="bg-blue-500 p-6 md:flex md:items-center md:justify-between text-white space-x-6">
        <div className="md:flex items-center md:space-x-64">
            <div className="py-5 px-4">
                <Image src={"https://sarufi.io/images/logo_w_text.svg"} height={200} width={100} alt='sarufi'/>
            </div>
            <nav className={`md:flex md:items-center md:justify-center ${isVisible ? 'block': 'hidden'} `}>
                <ul className=" md:flex md:space-x-6 space-y-3">
        ...
        <div className="md:flex md:items-center md:space-x-6">
            <div className={`md:flex md:pb-4 mr-6 ${isVisible ? 'block': 'hidden'} `}>
                <Button label='Login'/>
            </div>
        </div>
